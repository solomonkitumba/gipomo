...
To use these stylesheets, rename the files and girl_power with the name of your theme.
...
girl_power-alpha-default-narrow.css  
...
girl_power-alpha-default-normal.css
...
girl_power-alpha-default-wide.css
